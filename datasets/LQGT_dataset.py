...
class LQGTDataset(data.Dataset):
    ...
    def __init__(self, dataset_opt):
        ...
        self.paths_GT, self.sizes_GT = util.get_image_paths(self.data_type, dataset_opt['dataroot_GT'])
        self.paths_LQ, self.sizes_LQ = util.get_image_paths(self.data_type, dataset_opt['dataroot_LQ'])
